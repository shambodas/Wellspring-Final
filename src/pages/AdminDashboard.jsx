...
const AdminDashboard = () => {
  ...
  const users = [
    { id: 1, name: 'Sarah M.', email: 'sarah@email.com', status: 'active', lastActive: '2 min ago', mood: 'Happy', risk: 'low', sessions: 12 },
    { id: 2, name: 'Mike R.', email: 'mike@email.com', status: 'active', lastActive: '15 min ago', mood: 'Calm', risk: 'low', sessions: 8 },
    { id: 3, name: 'Emma L.', email: 'emma@email.com', status: 'inactive', lastActive: '2 days ago', mood: 'Anxious', risk: 'medium', sessions: 5 },
    { id: 4, name: 'David K.', email: 'david@email.com', status: 'active', lastActive: '1 hour ago', mood: 'Happy', risk: 'low', sessions: 15 },
    { id: 5, name: 'Lisa P.', email: 'lisa@email.com', status: 'active', lastActive: '3 hours ago', mood: 'Stressed', risk: 'high', sessions: 3 }
  ]
